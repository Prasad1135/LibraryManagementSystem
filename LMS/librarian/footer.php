    ...
    <footer class="footer">
				...
				<img class="stilogo" src="../logo.png" class="img-rounded">
				</div>
      <div class="container">
	  <div class="foot-margin">
        <p><a></br>SPPU University . All Rights Reserved. Developed by <a href="https://arihant.education/" target="_blank">Prasad Mane</a></p>
      </div>
      </div>
    </footer>
